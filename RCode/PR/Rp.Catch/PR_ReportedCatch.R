...
rc_16on <- fread(file = here('RCode', 'PR', 'Dat16toPresent', 'Data', 'i2_data_16to24.csv'), fill = TRUE) %>%
  mutate_all(as.character)
...
write.csv(notused, 'Outputs/PR/NotUsed/i2/notused.csv', row.names = F, na = "")
...
write.csv(notused2, 'Outputs/PR/NotUsed/i2/notused2.csv', row.names = F, na = "")
...
write.csv(notused3, 'Outputs/PR/NotUsed/i2/notused3.csv', row.names = F, na = "")
...
write.csv(notused4, 'Outputs/PR/NotUsed/i2/notused4.csv', row.names = F, na = "")
...
write.csv(rc_by_id_agg, "Outputs/PR/rc.csv", na = "", row.names = F)
write.csv(notused_summary, "Outputs/PR/rc_notused_summary.csv", na = "", row.names = F)
