...
# read in location data for 16-24. New years of data can be added in the PR_readdata_16_present.R data
i8_new = fread(file = here('RCode', 'PR', 'Dat16toPresent', 'Data', 'i8_data_16to24.csv'), fill = TRUE) %>%
...
write.csv(notused, 'Outputs/PR/NotUsed/i8/notused.csv', row.names = F, na = "")
...
write.csv(notused2, 'Outputs/PR/NotUsed/i8/notused2.csv', row.names = F, na = "")
...
write.csv(notused3, 'Outputs/PR/NotUsed/i8/notused3.csv', row.names = F, na = "")
...
write.csv(notused4, 'Outputs/PR/NotUsed/i8/notused4.csv', row.names = F, na = "")
...
write.csv(notused5, 'Outputs/PR/NotUsed/i8/notused5.csv', row.names = F, na = "")
...
write.csv(notused6, 'Outputs/PR/NotUsed/i8/notused6.csv', row.names = F, na = "")
...
write.csv(all_locations, "Outputs/PR/location_cleaned.csv", na = "", row.names = F)
write.csv(notused_summary, "Outputs/PR/location_notusedsummary.csv", na = "", row.names = F)
