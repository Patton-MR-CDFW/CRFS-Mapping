...
output = read.csv(here('Outputs','PR', 'all_by_id.csv'))
...
WHERE = "C:\\GIS\\CRFSMapping\\Outputs\\PR\\"
...
long_name = paste0('PR_',SPECIES, '_',TRIPTYPE, '_', MINIMUM_SAMPLES ,'_SAMPLES_long.shp')
...
wide_name = paste0('PR_', SPECIES, '_',TRIPTYPE, '_', MINIMUM_SAMPLES ,'_SAMPLES_', METRIC, '.shp')
...
wide_group_name = paste0('PR_', SPECIES, '_',TRIPTYPE, '_', MINIMUM_SAMPLES ,'_SAMPLES_', '_GROUPS', '.shp')
